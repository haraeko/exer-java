...
<script type="text/javascript">
	...
	//	给保存按钮添加单击事件
		...
		//	表单验证
			...
			$.ajax({
				url:'workbench/clue/saveCreatClue.do',
				data:{
					//不加‘’
					fullname:fullname,
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="saveCreateClueBtn" class="btn btn-primary" data-dismiss="modal">保存</button>
				</div>
			</div>
		</div>
	</div>
...
<%--					美工写死的，因为没有做分页查询--%>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detailClue.do?id=f4c790968848451e8b7edd9cc3fe827e';">王五</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
